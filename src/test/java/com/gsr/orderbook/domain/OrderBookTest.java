...
import com.gsr.orderbook.OrderBookPrinter;
...
class OrderBookTest {
    ...
    void whenOrderIsACancelOrder_DoNotAdd_OnlyRemove() {
        ...
        assertThat(argumentCaptor.getAllValues()).containsExactly(cancelOrder);
    }
    ...
    void whenOrderIsNotCancelOrder_addToOrderBook() {
        ...
        assertThat(argumentCaptor.getAllValues()).containsExactly(order);
    }
